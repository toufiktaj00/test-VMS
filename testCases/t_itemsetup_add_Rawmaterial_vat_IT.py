...
class Test_001_ItemSetup:
 ...
 # Dropdown
    #Item
        ...
        self.itemsetup.setItemTypedrpSearchData("Raw Material")
    ...
    #Material
        ...
        self.itemsetup.clickdrpRawMaterialType()

        self.itemsetup.setMaterialTypeDrpSearchData("Test")

        self.itemsetup.clickRawMaterialTypeSearchData()
        time.sleep(1)
