...
class Test_001_MeasureUnit:
    ...
    def test_login(self, setup):
        ...
        searchitem.setSearchData("test1")
        time.sleep(2)

        self.measureunit.clickAddchild()
        time.sleep(2)
# Dropdown

        self.measureunit.clickUnitTo()

        self.measureunit.setdrpSearchData("Pcs.")

        self.measureunit.clickSearchData()
        time.sleep(2)

# End Dropdown

        self.qty = random_generator()
        self.measureunit.setConvQty(self.qty)  # Changed method name to setConvQty
        time.sleep(1)

        self.measureunit.clickCreate()
        time.sleep(.5)
