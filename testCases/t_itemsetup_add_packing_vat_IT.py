...
class Test_001_ItemSetupPack:
 ...
 # Dropdown
    #Item
        ...
        self.itemsetup.setItemTypedrpSearchData("Packing Material")
    ...
    #Material
        ...
        self.itemsetup.clickdrpPackMaterialType()

        self.itemsetup.setMaterialTypeDrpSearchData("Inner")

        self.itemsetup.clickPackingMaterialTypeSearchData()
        time.sleep(1)
    # HS Code
...
# Vat Flag
        ...
        self.itemsetup.clickVatFlag()
# sales vat
        self.itemsetup.setSalesVat(15)
# sales exp vat
        self.itemsetup.setSalesExpVat(19)
        time.sleep(1)

# Rebat flag
        self.itemsetup.clickRebatable()
# purch vat
        self.itemsetup.setPurchVat(13)
# purch imp vat
        self.itemsetup.setPurchImpVat(11)
        time.sleep(1)

# SD flag
        self.itemsetup.clickSD()
# sd amount
        self.itemsetup.setSD(17)
        time.sleep(1)
